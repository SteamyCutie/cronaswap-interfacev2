...
const GronaUtility = () => {
  const styleCard =
    'grid p-2 md:p-4 rounded-xl bg-dark-700 gap-1 items-center justify-center justify-items-center w-full'
  const styleIllustr = `${styleCard} gap-4 p-6 px-4 md:p-8`
  return (
    <div className="grid items-start justify-center grid-cols-1 gap-4 p-4 bg-cover md:p-6 bg-dark-700/60 rounded-2xl">
      <div className="m-3 text-2xl font-extrabold text-center">Golden CRONA Utility</div>
      <div className="grid gap-4 grid-cols-2 md:grid-cols-4">
        <div className="grid col-span-2 gap-3">
          ...
          <div className="grid grid-cols-9 justify-center items-center bg-dark-700 rounded-xl px-4 md:px-8">
        ...
        <div className="grid gap-3">
          ...
          <div className={styleIllustr}>
            ...
            <div className="text-center font-extrabold min-h-[48px] items-center flex">Exclusive IFO Access</div>
